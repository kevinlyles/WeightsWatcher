...
local PreprocessLines = {
	...
	{"^use: teaches you how to permanently enchant a melee weapon to occasionally grant you 120 critical strike rating%. requires a level 60 or higher item%.$", "executioner"},
	...
	{"^use: teaches you how to permanently enchant a weapon to sometimes grant blade warding when striking an enemy, increasing parry rating and inflicting damage on your next parry%.  enchantment requires level 75%.$", "blade ward"},
	...
	{"^use: teaches you how to permanently enchant a weapon to sometimes increase dodge rating and movement speed when striking in melee%.  requires a level 300 or higher item%.$", "windwalk"},
