...
local PreprocessLines = {
	...
	{"^use: permanently enchant a melee weapon to occasionally heal nearby party members for 240 when attacking in melee%. +requires a level 35 or higher item%.$", "battlemaster"},
	...
	{"^use: permanently enchant a melee weapon to often heal for 100 and increase strength by 100 for 15 sec%. when attacking in melee%. has a reduced effect for players above level 60%.$", "crusader"},
	...
	{"^use: permanently enchant a weapon to often deal %d%d%d nature damage to an enemy damaged by your spells or struck by your melee attacks%. +requires a level 300 or higher item%.$", "avalanche"},
	...
	{"^use: permanently enchant a weapon to sometimes grant blade warding when striking an enemy%. +blade warding increases your parry by 200 and inflicts 700 damage on your next parry%. +lasts 10 sec%.[\r\n ]+this enchantment requires the wielder is at least level 75%.$", "blade ward"},
	...
	{"^use: permanently enchants a melee weapon to sometimes inflict 3,?000 additional elemental damage when dealing damage with spells and melee attacks%. +requires a level 372 or higher item%.$", "elemental force"},
